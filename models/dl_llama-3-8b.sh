...
huggingface-cli download meta-llama/Meta-Llama-3-8B --exclude "original/*" --local-dir Meta-Llama-3-8B --cache-dir /home/hice1/spark868/scratch/.cache/huggingface
