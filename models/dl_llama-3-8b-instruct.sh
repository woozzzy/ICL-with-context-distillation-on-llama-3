...
huggingface-cli download meta-llama/Meta-Llama-3-8B-Instruct --exclude "original/*" --local-dir Meta-Llama-3-8B-Instruct --cache-dir /home/hice1/spark868/scratch/.cache/huggingface
